#!/usr/bin/env python3
"""
Ray-based distributed orchestrator for XGBoost townhouse price prediction
Runs from MacBook, coordinates training across Linux VM (RTX 3090) and WSL2 (RTX 4090)
"""
...
# ===================== CONFIGURATION =====================
HEAD = "ray://10.0.0.75:10001"  # Ray Client address (Linux VM)
